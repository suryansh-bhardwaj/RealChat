...
Stream Chat Account - Get API credentials from getstream.io

🚀 Installation

1. Clone the repository

git clone https://github.com/suryansh-bhardwaj/RealChat.git
...
RealChat supports multiple themes via DaisyUI. Users can switch themes from the theme selector component.
...
GitHub: @suryansh-bhardwaj

🙏 Acknowledgments

Stream Chat for the amazing chat API
